      ...
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-start justify-between gap-3">
            <div>
              <h3 className="font-semibold text-slate-900">{request.internName}</h3>
              <p className="text-sm text-slate-500">{request.field}</p>
            </div>
          ...
          <p className="mt-2 text-xs text-slate-400">Sent: {request.sentDate}</p>
